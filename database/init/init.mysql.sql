...
REPLACE INTO `settings` (`uuid`, `mainkey`, `subkey`, `value`) VALUES ('00000000-0000-0000-0000-000000000000','whitelist','172.17.0.3','{\"canDelete\": 0, \"ip\": \"172.17.0.3\", \"description\": \"docker\"}');
